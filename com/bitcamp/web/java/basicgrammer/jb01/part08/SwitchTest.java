package com.bitcamp.web.java.basicgrammer.jb01.part08;
    ...
    public static void main(String[] args) {
        ...
        switch (inputData) {
            ...
            case 5:
                ...
                break;
            default:
                System.out.println("case문을 전부 통과 (동일상수가 없을 경우)");
                System.out.println("default가 수행된다. 입력하신 수는" + inputData + "입니다.");
                break;
        }
